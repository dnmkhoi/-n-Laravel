...
class CreateSanphamTable extends Migration {
    ...
    public function up() {
        Schema::create('cusc_sanpham', function (Blueprint $table) {
            ...
            $table->tinyInteger('sp_maybo')->default('1')->comment('Loại máy tính - 1:laptop, 2: máy bàn');
        ...
        DB::statement("ALTER TABLE `cusc_sanpham` comment 'Sản phẩm # Sản phẩm: LapTop,Máy bộ,máy bàn, ...'");
    }
