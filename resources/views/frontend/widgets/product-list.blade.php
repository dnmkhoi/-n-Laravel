<div class="bg0 m-t-23 p-b-140">
    <div class="container">
        ...
        <div class="row isotope-grid show-products">
            ...
            <div class="col-md-3 p-b-35 isotope-item loai-{{ $sp->l_ma }} target" id="sanpham">
                <!-- Block2 -->
                <div class="block2">
                    ...
                    <div class="block2-txt flex-w flex-t p-t-14">
                        ...
                        <a href="#" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6 detail-sp data-sp-ma="{{ $sp->sp_ma }}">
                                {{ $sp->sp_ten }}
                            </a>
